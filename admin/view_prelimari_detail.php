...
$query = "SELECT * FROM tbl_prelimari WHERE id = $id";
...
<div class="container my-5">
    <div class="card shadow">
        <div class="card-header bg-info text-white">
            <h4 class="mb-0">Preliminary Notice Details</h4>
        </div>
        <div class="card-body">
            ...
            $sections = [
                ...
                'Customer Information' => [
                    'Name of Person/Company that hired you' => $row['name_of_person'],
                    ...
                    'State' => $row['state'],
                    'Zip' => $row['zip_code'],
                    'Materials Delivered' => $row['materials_deliverd'],
                    'Job Site Address' => $row['job_site_address'],
                    'Job Site Address 2 / State' => $row['job_site_address2']
                ],
